...
SAVE_PATH=""
DATASET_PATH=""
MODEL_PATH="/data_large_v2/liangxiaoyun/model_output/Qwen3-32B"
LOAD_PATH="/data_large_v2/liangxiaoyun/model_output/Qwen3-32B-megatron"
MASTER_PORT=29900
MICRO_BATCH_SIZE=16
...
print_usage() {
    ...
    echo "  --save_strategy <str>  保存模型的策略，可选为'no'、'steps'、'epoch'(默认: ${SAVE_STRATEGY})"
...
export MODELSCOPE_CACHE="/data_large_v2/liangxiaoyun/modelscope_cache_new"
...
# ========== 启动训练 ==========
export PYTORCH_CUDA_ALLOC_CONF='expandable_segments:True' && NVTE_DEBUG=0 /data_fast_v2/eoncanyang/miniforge3/envs/swift/bin/megatron sft \\
    --load ${LOAD_PATH} \\
    --model ${MODEL_PATH} \\
    ...
    --log_interval 1 \\
    --packing true \\
    --loss_scale hermes_ignore_empty_think \\
